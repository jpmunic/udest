...
#with open(join(dirname(__file__), '../scripts/freeresponse.txt') as personality_text:personality_insights_json = {"contentItems": [{"id": "245160944223793152", "userid": "bob", "sourceid": "twitter", "created": 1427720427,"updated": 1427720427, "contenttype": "text/plain", "charset": "UTF-8", "language": "en-us","content": personality_text.read(), "parentid": "", "reply": "false", "forward": "false"}]}:
